...
void PIT_IRQHandler()
{
	...
	q = 10000;										//Counter to exit loop 
	
	TPM0_CNT = 1;										//Reset counter
	
	do{q--;}while (((TPM0_C2SC & (1<<7))==0) && (q));  	//Wait rising edge
	...
	q = 10000;										//Counter to exit 
	
	do{q--;}while (((TPM0_C2SC & (1<<7))==0) && (q));  	//Wait falling edge
	...
	if (distancia<10)									//Condition depending distance
	{
